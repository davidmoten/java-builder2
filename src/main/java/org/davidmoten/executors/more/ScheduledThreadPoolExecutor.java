...
public class ScheduledThreadPoolExecutor extends ThreadPoolExecutor implements ScheduledExecutorService {
     ...
     */
    private final boolean continueExistingPeriodicTasksAfterShutdown;

    /**
     * False if should cancel non-periodic tasks on shutdown.
     */
    private final boolean executeExistingDelayedTasksAfterShutdown;
    ...
    public ScheduledThreadPoolExecutor(int corePoolSize, ThreadFactory threadFactory) {
        super(corePoolSize, Integer.MAX_VALUE, 0, NANOSECONDS, false, new DelayedWorkQueue(), threadFactory);
    ...
    public ScheduledThreadPoolExecutor(int corePoolSize, ThreadFactory threadFactory,
        ...
        this(corePoolSize, threadFactory, handler, false, true, false);
    }

    public ScheduledThreadPoolExecutor(int corePoolSize, ThreadFactory threadFactory, RejectedExecutionHandler handler,
            boolean continueExistingPerioidicTasksAfterShutdown, boolean executeExistingDelayedTasksAfterShutdown,
            boolean removeOnCancel) {
        super(corePoolSize, Integer.MAX_VALUE, 0, NANOSECONDS, false, new DelayedWorkQueue(), threadFactory, handler);
        this.continueExistingPeriodicTasksAfterShutdown = continueExistingPerioidicTasksAfterShutdown;
    ...
    public <T> Future<T> submit(Runnable task, T result) {
        return schedule(java.util.concurrent.Executors.callable(task, result), 0, NANOSECONDS);
    }
    ...
    static class DelayedWorkQueue extends AbstractQueue<Runnable> implements BlockingQueue<Runnable> {
        ...
        /**
         * Returns first element only if it is expired. Used only by drainTo. Call only
         * when holding lock.
         */
